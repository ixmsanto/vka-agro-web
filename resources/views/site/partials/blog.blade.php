<section id="blog" style="position:relative;padding:clamp(64px,9vw,120px) 0;scroll-margin-top:80px">
    ...
    <div style="max-width:1400px;margin:0 auto;padding:0 clamp(20px,4vw,48px);position:relative;z-index:1">
        <div style="display:flex;flex-wrap:wrap;align-items:flex-end;justify-content:space-between;gap:24px;margin-bottom:clamp(32px,4vw,52px)">
            <div style="max-width:620px">
                ...
                <h2 data-split="1" style="font-family:'Newsreader',serif;font-weight:400;font-size:clamp(34px,4.4vw,60px);line-height:1.06;letter-spacing:-0.015em;margin:18px 0 0;color:#123C2D">Guides from the <span style="font-style:italic;color:#63BE46">growing floor.</span></h2>
            </div>
