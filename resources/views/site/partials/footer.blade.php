...
<footer style="margin:0 clamp(12px,2vw,28px) clamp(12px,2vw,28px);background:linear-gradient(160deg, rgba(33,80,60,0.94), rgba(23,60,44,0.96));border:1px solid rgba(255,255,255,0.12);border-radius:26px;padding:clamp(34px,4vw,52px) 0 26px;backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);box-shadow:0 24px 60px rgba(33,80,60,0.22)">
    <div style="max-width:1400px;margin:0 auto;padding:0 clamp(24px,4vw,56px)">
        <div data-fgrid style="display:grid;grid-template-columns:1.5fr 1fr 1fr 1.3fr;gap:clamp(28px,4vw,64px);align-items:start">
            ...
            <div>
                <div style="font-family:'Newsreader',serif;font-size:28px;color:#FFFFFF">VKA<span style="font-style:italic;color:#63BE46">&nbsp;Agro</span></div>
                <p style="font-size:14px;line-height:1.65;color:rgba(255,255,255,0.62);margin:14px 0 0;max-width:34ch">Premium coco peat, grow bags and husk chips — manufactured in Pollachi and exported to 40+ countries.</p>
            ...
            <div>
                <div style="font-size:12px;letter-spacing:0.14em;text-transform:uppercase;font-weight:700;color:rgba(255,255,255,0.5)">Explore</div>
                <div style="display:flex;flex-direction:column;gap:11px;margin-top:16px">
                    @foreach ($explore as $href => $label)
                        <a href="{{ $href }}" class="vka-link-muted" style="font-size:14px;color:rgba(255,255,255,0.78)">{{ $label }}</a>
                    @endforeach
                </div>
            </div>

            <div>
                <div style="font-size:12px;letter-spacing:0.14em;text-transform:uppercase;font-weight:700;color:rgba(255,255,255,0.5)">Products</div>
                <div style="display:flex;flex-direction:column;gap:11px;margin-top:16px">
            ...
            <div>
                <div style="font-size:12px;letter-spacing:0.14em;text-transform:uppercase;font-weight:700;color:rgba(255,255,255,0.5)">Export desk</div>
                <div style="display:flex;flex-direction:column;gap:12px;margin-top:16px">
                    <div style="display:flex;gap:10px;align-items:flex-start">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#63BE46" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" style="flex:0 0 auto;margin-top:2px" aria-hidden="true"><path d="M21 10c0 6-9 12-9 12s-9-6-9-12a9 9 0 0 1 18 0Z"/><circle cx="12" cy="10" r="3"/></svg>
                        <span style="font-size:13.5px;line-height:1.5;color:rgba(255,255,255,0.78)">{{ $contact['address'] }}</span>
                    </div>
                    <a href="mailto:{{ $contact['email'] }}" class="vka-link-muted" style="display:flex;gap:10px;align-items:center;font-size:14px;color:#FFFFFF"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#63BE46" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" style="flex:0 0 auto" aria-hidden="true"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m2 6 10 7 10-7"/></svg>{{ $contact['email'] }}</a>
                    <a href="tel:{{ $contact['phoneHref'] }}" class="vka-link-muted" style="display:flex;gap:10px;align-items:center;font-size:14px;color:#FFFFFF"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#63BE46" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" style="flex:0 0 auto" aria-hidden="true"><path d="M22 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3 19.5 19.5 0 0 1-6-6 19.8 19.8 0 0 1-3-8.6A2 2 0 0 1 4.1 2h3a2 2 0 0 1 2 1.7c.1 1 .4 1.9.7 2.8a2 2 0 0 1-.5 2.1L8.1 9.8a16 16 0 0 0 6 6l1.2-1.2a2 2 0 0 1 2.1-.5c.9.3 1.8.6 2.8.7a2 2 0 0 1 1.7 2Z"/></svg>{{ $contact['phone'] }}</a>
                    <div style="display:flex;flex-wrap:wrap;gap:6px;margin-top:2px">
                        <span style="font-size:11px;font-weight:600;color:rgba(255,255,255,0.8);background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.14);border-radius:999px;padding:5px 11px">ISO 9001:2015</span>
                        <span style="font-size:11px;font-weight:600;color:rgba(255,255,255,0.8);background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.14);border-radius:999px;padding:5px 11px">IEC Registered</span>
                    </div>
                </div>
            </div>
        ...
        <div style="display:flex;flex-wrap:wrap;justify-content:space-between;align-items:center;gap:14px;margin-top:clamp(26px,3vw,36px);padding-top:20px;border-top:1px solid rgba(255,255,255,0.14)">
            <div style="font-size:12.5px;color:rgba(255,255,255,0.5)">© {{ date('Y') }} VKA Agro Exports · Made in Tamil Nadu, India</div>
            <div style="display:flex;flex-wrap:wrap;gap:18px">
                <a href="#" class="vka-link-muted" style="font-size:12.5px;color:rgba(255,255,255,0.5)">Privacy Policy</a>
                <a href="#" class="vka-link-muted" style="font-size:12.5px;color:rgba(255,255,255,0.5)">Terms of Trade</a>
                <a href="{{ route('admin.dashboard') }}" class="vka-link-muted" style="font-size:12.5px;color:rgba(255,255,255,0.5)">Admin</a>
            </div>
        </div>
    </div>
</footer>
...
{{-- floating actions --}}
<div style="position:fixed;right:clamp(16px,2vw,26px);bottom:clamp(16px,2vw,26px);z-index:95;display:flex;flex-direction:column;align-items:flex-end;gap:14px">
