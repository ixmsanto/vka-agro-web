...
<section id="video" style="position:relative;padding:clamp(20px,4vw,60px) 0 clamp(52px,6vw,84px)">
    <x-deco shape="dots" size="46" pos="top:12%;left:3.5%" opacity="0.27" motion="drift" wide />
    ...
    <div style="max-width:1400px;margin:0 auto;padding:0 var(--gutter);position:relative;z-index:1">
        ...
        <div data-reveal="2" data-fx="mask" style="position:relative;width:100%;max-width:980px;margin:0 auto;aspect-ratio:2400 / 1350;border-radius:clamp(16px,1.6vw,22px);overflow:hidden;box-shadow:0 26px 60px rgba(33,80,60,0.2), 0 10px 24px rgba(33,80,60,0.09);background:#0E2A20">
